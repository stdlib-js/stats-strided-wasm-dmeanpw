...
// Attached to the main export is a `main` method which returns a number...
{
	...
	dmeanpw.main( x.length, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	dmeanpw.main( '10', x, 1 ); // $ExpectError
	dmeanpw.main( true, x, 1 ); // $ExpectError
	dmeanpw.main( false, x, 1 ); // $ExpectError
	dmeanpw.main( null, x, 1 ); // $ExpectError
	dmeanpw.main( undefined, x, 1 ); // $ExpectError
	dmeanpw.main( [], x, 1 ); // $ExpectError
	dmeanpw.main( {}, x, 1 ); // $ExpectError
	dmeanpw.main( ( x: number ): number => x, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float64Array...
{
	...
	dmeanpw.main( x.length, 10, 1 ); // $ExpectError
	dmeanpw.main( x.length, '10', 1 ); // $ExpectError
	dmeanpw.main( x.length, true, 1 ); // $ExpectError
	dmeanpw.main( x.length, false, 1 ); // $ExpectError
	dmeanpw.main( x.length, null, 1 ); // $ExpectError
	dmeanpw.main( x.length, undefined, 1 ); // $ExpectError
	dmeanpw.main( x.length, [], 1 ); // $ExpectError
	dmeanpw.main( x.length, {}, 1 ); // $ExpectError
	dmeanpw.main( x.length, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	dmeanpw.main( x.length, x, '10' ); // $ExpectError
	dmeanpw.main( x.length, x, true ); // $ExpectError
	dmeanpw.main( x.length, x, false ); // $ExpectError
	dmeanpw.main( x.length, x, null ); // $ExpectError
	dmeanpw.main( x.length, x, undefined ); // $ExpectError
	dmeanpw.main( x.length, x, [] ); // $ExpectError
	dmeanpw.main( x.length, x, {} ); // $ExpectError
	dmeanpw.main( x.length, x, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	dmeanpw.main(); // $ExpectError
	dmeanpw.main( x.length ); // $ExpectError
	dmeanpw.main( x.length, x ); // $ExpectError
	dmeanpw.main( x.length, x, 1, 10 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	dmeanpw.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	dmeanpw.Module( '10' ); // $ExpectError
	dmeanpw.Module( true ); // $ExpectError
	dmeanpw.Module( false ); // $ExpectError
	dmeanpw.Module( null ); // $ExpectError
	dmeanpw.Module( undefined ); // $ExpectError
	dmeanpw.Module( [] ); // $ExpectError
	dmeanpw.Module( {} ); // $ExpectError
	dmeanpw.Module( ( x: number ): number => x ); // $ExpectError
}
